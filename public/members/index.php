  ...
  <div class="members listing">
    ...
    <table class="list">
      ...
      <tr>
        ...
        <td><a class="action"
            href="<?php echo url_for('/members/show.php?id=' . h(u($member['member_ID']))); ?>">View</a></td>
        <td><a class="action"
            href="<?php echo url_for('/members/edit.php?id=' . h(u($member['member_ID']))); ?>">Edit</a></td>
        <td><a class="action"
            href="<?php echo url_for('/members/delete.php?id=' . h(u($member['member_ID']))); ?>">Delete</a></td>
      </tr>
      <?php }; ?>
    </table>
